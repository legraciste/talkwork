    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST3.php" method="post">
                    <label for="Q2">Quelle balise HTML permet de mettre en gras ?</label><br><br>
                    <input type="radio" id="Q2" name="Q2" value="b"><label for="b">  b</label><br><br>
                    <input type="radio" id="Q2" name="Q2" value="u"><label for="u">  u</label><br><br>
                    <input type="radio" id="Q2" name="Q2" value="span"><label for="span">  span</label><br><br>
                    <input type="radio" id="Q2" name="Q2" value="br"><label for="br">  br</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST3.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
