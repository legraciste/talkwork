    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST4.php" method="post">
                    <label for="Q3">Quelle balise HTML permet de creer une liste ordonnée ?</label><br><br>
                    <input type="radio" id="Q3" name="Q3" value="ul"><label for="ul">  ul</label><br><br>
                    <input type="radio" id="Q3" name="Q3"  value="ol"><label for="ol">  ol</label><br><br>
                    <input type="radio" id="Q3" name="Q3" value="div"><label for="div">  div</label><br><br>
                    <input type="radio" id="Q3" name="Q3" value="li"><label for="li">  li</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST4.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
