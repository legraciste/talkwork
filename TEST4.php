    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST5.php" method="post">
                    <label for="Q4">Quelle est le protocole reseau utilise pour internet ?</label><br><br>
                    <input type="radio" id="Q4" name="Q4" value="TCP"><label for="TCP">  TCP</label><br><br>
                    <input type="radio" id="Q4" name="Q4" value="IPX"><label for="IPX">  IPX</label><br><br>
                    <input type="radio" id="Q4" name="Q4" value="IP"><label for="IP">  IP</label><br><br>
                    <input type="radio" id="Q4" name="Q4" value="DHCP"><label for="DHCP">  DHCP</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST5.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
