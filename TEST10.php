<html>
    <head>
        ...
        <link rel="shorcut icon" type="image/png" href="OIP.jpeg"><script language="JavaScript">
    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="conclusion.php" method="post">
                    <label for="Q10">Quelle balise HTML permet de surligner le texte</label><br><br>
                    <input type="radio" id="Q10" name="Q10" value="mark" ><label for="mark">  mark</label><br><br>
                    <input type="radio" id="Q10" name="Q10" value="u" ><label for="u">  u</label><br><br>
                    <input type="radio" id="Q10" name="Q10" value="div" ><label for="div">  div</label><br><br>
                    <input type="radio" id="Q10" name="Q10" value="b" ><label for="b">  b</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'conclusion.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
