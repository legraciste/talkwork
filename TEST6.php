    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST7.php" method="post">
                    <label for="Q6">Qelle requete est utilise pour supprimer une table ?</label><br><br>
                    <input type="radio" id="Q6" name="Q6" value="DROP TABLE" ><label for="DRT">  DROP TABLE</label><br><br>
                    <input type="radio" id="Q6" name="Q6" value="DELETE TABLE" ><label for="DET">  DELETE TABLE</label><br><br>
                    <input type="radio" id="Q6" name="Q6" value="REMOVE TABLE" ><label for="REMT">  REMOVE TABLE</label><br><br>
                    <input type="radio" id="Q6" name="Q6" value="RESET TABLE" ><label for="REST">  RESET TABLE</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST7.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
