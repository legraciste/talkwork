...
?>
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST8.php" method="post">
                    <label for="Q7">Lequel de ces langages n'est pas orienté objet ?</label><br><br>
                    <input type="radio" id="Q7" name="Q7" value="JAVA" ><label for="JAVA">  JAVA</label><br><br>
                    <input type="radio" id="Q7" name="Q7" value="C++" ><label for="C++">  C++</label><br><br>
                    <input type="radio" id="Q7" name="Q7" value="C" ><label for="C">  C</label><br><br>
                    <input type="radio" id="Q7" name="Q7" value="C#" ><label for="C#">  C#</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  var countdown = 10; // Durée du compte à rebours en secondes
                  var timer = setInterval(function() {
                  countdown--;
                  document.getElementById('countdown').innerHTML = countdown + 's';
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST8.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
