    ...
    <body onunload="window.history.forward()">
        ...
        <div id="display-container">
            ...
            <div id="container">
                <form action="TEST9.php" method="post">
                    <label for="Q9">Quel balise HTML permet de creer une liste non ordonnée ?</label><br><br>
                    <input type="radio" id="Q8" name="Q8" value="textarea" ><label for="textarea">  textarea</label><br><br>
                    <input type="radio" id="Q8" name="Q8" value="img" ><label for="img">  img</label><br><br>
                    <input type="radio" id="Q8" name="Q8" value="a" ><label for="a">  a</label><br><br>
                    <input type="radio" id="Q8" name="Q8" value="ul" ><label for="ul">  ul</label>
                    </div>
        ...
        <div class="score-container hide">
            ...
            <script>
                  ...
                  if (countdown == 0) {
                  clearInterval(timer);
                  window.location.href = 'TEST9.php?cpt=<?php echo $cpt; ?>'; // Passer à la question suivante
               }
               }, 1000);
            </script>
        </script>
